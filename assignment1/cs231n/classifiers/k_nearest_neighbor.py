...
class KNearestNeighbor(object):
  ...
  def predict_labels(self, dists, k=1):
    ...
    for i in xrange(num_test):
      ...
      #########################################################################
      sortdists = np.argsort(dists) # Sort the distances in dists
      knearest_one = sortdists[i, 0:k] # column 0 has the nearest one
      knearest_class = self.y_train[knearest_one] # Get the class
      closest_y.extend(knearest_class)
      pass
      #########################################################################
      # TODO:                                                                 #
      ...
      # label.                                                                #
      #########################################################################
      counts = np.bincount(closest_y) # Get the count of each value
